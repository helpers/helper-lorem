...
describe('lorem', function () {
  ...
  describe('templates', function () {
    it('should work as a lodash import/helper:', function () {
      var settings = {imports: {lorem: loremHelper}};
      _.template('<%= lorem() %>', {}, settings).should.be.a.string;
      (/<%/.test(_.template('<%= lorem() %>', {}, settings))).should.be.false;
    });

    it('should work as a handlebars helper:', function () {
      handlebars.compile('{{lorem}}')().should.be.a.string;
      (/<%/.test(handlebars.compile('{{lorem}}')())).should.be.false;
    });
